            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Tomás:`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Software Developer.", "Game Developer.", "Technology Lover." ]'><span className="wrap">{text}</span></span></h1>
                  ...
                  <button onClick={() => console.log('connect')}>Download CV <a download href="/src/components/TomásFernándezValdés_SoftwareDev_ENG.pdf"><ArrowRightCircle size={25} /></a></button>
              </div>}
            </TrackVisibility>
          </Col>
          <Col xs={12} md={6} xl={5}>
