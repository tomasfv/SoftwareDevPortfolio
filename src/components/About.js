            ...
            <div className="">
                <div className="">
                    <div className="skill-bx wow zoomIn">
                        ...
                        <div className="about">
                            <p>From Music Composer to Software Developer... since I was a child I have always been fascinated by technology and interactive experiences, but it was when I got into the video games industry that I discovered programming and set out to learn how to code.</p>
                            ...
                            <p>I am currently working as a software developer at the company Getback, and doing a 6-month internship in the great studio Landell Games, while I create my own video games and continue training in Unity and C# in my spare time; two technologies that I find fascinating for the development of interactive experiences and games.</p>
